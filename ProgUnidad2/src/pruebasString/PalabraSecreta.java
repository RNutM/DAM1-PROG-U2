...
public class PalabraSecreta {
	 ...
	 * adivinarla en menos de 3 intentos o los que queramos poner cambiando el número.
	 * 
	 * @author Robert G
	 */
	...
	// Se seguirán dando oportunidades mientras que el usuario no acierte ni consuma los intentos
